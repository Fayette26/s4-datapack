...
execute if score message dingtimer matches 17 run minecraft:give @a paper[custom_model_data={floats:[25]},item_name={"bold":true,"color":"yellow","text":"Flower Token"},lore=[{"color":"dark_purple","text":"Can be traded for cosmetics at the Flower Festival"}]] 2
