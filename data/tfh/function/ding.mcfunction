...
execute if score message dingtimer matches 17 run tellraw @a[tag=!muteding] ["",{color:"white",text:"日 "},{color:"#a205ca",text:"The spring event is now live! Have some free tokens!"}]
